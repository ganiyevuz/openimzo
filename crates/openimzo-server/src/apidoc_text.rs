...
const TABLE: &[(&str, &str, &str)] = &[
    ...
    ("Плагин для генерации ключевой пары и формирования запроса на сертификат формата PKCS#10",
     "Kalit juftligini yaratish va PKCS#10 formatidagi sertifikat soʻrovini shakllantirish uchun plagin",
    ...
    ("Плагин для взаимодейтвия с ИОК",
     "OKI bilan oʻzaro ishlash uchun plagin",
    ...
    ("Загрузить ключ и получить идентификатор ключа. Ключ будет доступен определенное время",
     "Kalitni yuklash va kalit identifikatorini olish. Kalit maʼlum vaqt davomida ochiq boʻladi",
    ...
    ("Получить информацию о запросе PKCS#10",
     "PKCS#10 soʻrovi haqida maʼlumot olish",
    ...
    ("Получить список BAIK-Token ов",
     "BAIK-Tokenʼlar roʻyxatini olish",
     "List the BAIK tokens"),
    ("Получить список UZGUARD-Token ов",
     "UZGUARD-Tokenʼlar roʻyxatini olish",
    ...
    ("Персонализировать BAIK-Token записав новые сертификаты и установив PIN-код",
     "Yangi sertifikatlarni yozib va PIN-kod oʻrnatib BAIK-Tokenʼni shaxsiylashtirish",
    ...
    ("Персонализировать UZGUARD-Token записав новые сертификаты и установив PIN-код",
     "Yangi sertifikatlarni yozib va PIN-kod oʻrnatib UZGUARD-Tokenʼni shaxsiylashtirish",
    ...
    ("Получить информацию о сертификате",
     "Sertifikat haqida maʼlumot olish",
    ...
    ("Путь (должна быть пустой или 'DSKEYS')",
     "Yoʻl (boʻsh yoki ʼDSKEYSʼ boʻlishi kerak)",
    ...
    ("Имя субъекта в формате X.500 или '' если нужно получить имя из сертификата по идентификатору ключа",
     "X.500 formatidagi subyekt nomi, yoki kalit identifikatori boʻyicha sertifikatdan nom olinishi kerak boʻlsa ʼʼ",
    ...
    ("OIDы политик применения сертификатов разделенных запятой",
     "Vergul bilan ajratilgan sertifikatlardan foydalanish siyosati OIDʼlari",
     "Comma-separated OIDs of the certificate policies"),
    ("Случайные данные для инициализации генератора случайных чисел",
     "Tasodifiy sonlar generatorini ishga tushirish uchun tasodifiy maʼlumotlar",
    ...
    ("Данные в кодировке BASE64 (будут предваритьльно декодированы, подписаны и вложены в документ)",
     "BASE64 kodidagi maʼlumotlar (avval dekodlanadi, imzolanadi va hujjat ichiga joylanadi)",
    ...
    ("Возможные значения: 'yes' - будет создан PKCS#7/CMS документ без вложения исходных данных, 'no' или '' - будет создан PKCS#7/CMS документ с вложением исходных данных",
     "Mumkin boʻlgan qiymatlar: ʼyesʼ — asl maʼlumotlar joylanmagan PKCS#7/CMS hujjati yaratiladi; ʼnoʻ yoki ʼʼ — asl maʼlumotlar joylangan PKCS#7/CMS hujjati yaratiladi",
