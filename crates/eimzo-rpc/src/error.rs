...
impl From<eimzo_pki::PkiError> for RpcError {
    fn from(e: eimzo_pki::PkiError) -> Self {
        RpcError::Runtime(e.to_string())
    }
}

impl From<eimzo_crypto::CryptoError> for RpcError {
    fn from(e: eimzo_crypto::CryptoError) -> Self {
        RpcError::Runtime(e.to_string())
    }
}
